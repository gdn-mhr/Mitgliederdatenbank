...
/**
 *	This file enables the user to create a new view in archive.
 */
...
{
  global $opt;
  echo '<tr id="row0"><td><fieldset><label>Spalte auswählen</label><select name="col[]" class="form-control" >' .
    $opt .
    '</select></fieldset></td><td></td></tr>';
}
...
function Poster()
{
  echo 'includes/archive_view_create.php';
}
