...
<?php
	...
	$buttons = '<button id="add" class="btn btn-outline-success" onclick="window.location=\'data_new.php\';"><i class="glyphicon glyphicon-remove"></i> Eintrag hinzufügen</button>';
	
	//column to delete & archivate
	$additional_c = '<th data-field="Delete" data-editable="false" data-formatter="operateFormatter" data-events="operateEvents" data-width="30px">Archivieren & <br>  Löschen</th>';
