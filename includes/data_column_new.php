...
if (isset($link)) {
  ...
  log_column_create($name);

  //insert row
  $upd =
    "INSERT INTO `columns` (`id`, `name`, `access_level`) VALUES (NULL, '" .
    $name .
    "', '0');";
  ...
  $sql =
    "SELECT id, name, access_level FROM columns WHERE `name`='" . $name . "'";
  ...
  $upd_a =
    "INSERT INTO `archive_columns` (`id`, `name`, `access_level`) VALUES (" .
    $id .
    ", '" .
    $name .
    "', '0');";
