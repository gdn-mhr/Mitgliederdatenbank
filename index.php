...
<?php include 'includes/template_header.php'; ?>
	...
	<br>
        <p>		 <?php if (
          !(isset($_SESSION["sso"]) && isset($_SESSION["sso"]) == 1)
        ) {
          echo '<a style="display:inline-block; padding:5px;" href="user_password.php" class="btn btn-outline-warning">Passwort ändern</a>';
        } ?>
        ...
        <?php if ($_SESSION["access_level"] > 4) {
          echo '<a style="display:inline-block; padding:5px;" href="user_register.php" class="btn btn-outline-success">Neuen Benutzer erstellen</a>';
        } ?>
		<?php if ($_SESSION["access_level"] > 4) {
    echo '<a style="display:inline-block; padding:5px;" href="user_list.php" class="btn btn-outline-info">Benutzer anzeigen</a>';
  } ?>
		</p>
